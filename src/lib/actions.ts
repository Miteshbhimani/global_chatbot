...
import {
  answerQuestionsAboutWebsite,
  type AnswerQuestionsAboutWebsiteOutput,
} from '@/ai/flows/answer-questions-about-website';
...
export async function getAgentResponse(
  ...
  try {
    ...
    if (!response || !response.answer) {
      return {answer: 'I apologize, but I was unable to get a response. Please try again.'};
    }
    ...
    return {
      answer:
        'An error occurred while communicating with the agent. Please check the console for more details.',
    };
  }
}
